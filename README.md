...
[![Docker](https://img.shields.io/docker/v/stabgandocker/steelmind-mcp?label=docker)](https://hub.docker.com/r/stabgandocker/steelmind-mcp)
...
```json
{
  "mcpServers": {
    "steelmind": {
      "command": "docker",
      "args": ["run", "--rm", "-i", "stabgandocker/steelmind-mcp"]
    }
  }
}
```
